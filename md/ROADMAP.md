...
1. 清理指令文件绝对路径、未驱动端口和冗余或命名范围过窄的总线字段。
2. 决定下一项架构实验：请求/响应式内存边界，或最小异常/CSR/trap 流程。
3. 在确实需要批量运行归档测试时，再写可重复运行 Vivado/XSim 测试的 Tcl 流程。
...
- [x] Test 01–16 定向测试归档
- [x] 精确源寄存器使用信息
- [x] WB→MEM Load-to-Store-data 晚旁路
- [ ] 自动化综合回归
- [ ] 可移植的仿真入口
